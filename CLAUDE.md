...
## 7. [MISMATCH-LOG.md](MISMATCH-LOG.md) — журнал расхождений вёрстки и проекта

Файл [MISMATCH-LOG.md](MISMATCH-LOG.md) — реестр расхождений между эталоном [static-html/](static-html/) (правило 1) и текущей Next.js-реализацией. Используется при ручной сверке экранов и при чистке технического долга. **Не путать с [ONEENTRY-ADMIN-SETUP.md](ONEENTRY-ADMIN-SETUP.md):** там — пробелы в данных OneEntry (нужно завести сущность/атрибут/форму в админке); здесь — расхождения в коде/вёрстке, которые чинятся правкой самого проекта.
...
- **Приоритет работы:** при свободном бюджете на техдолг — сначала P0/P1 из раздела B, затем массовые находки раздела A.
...
- [ ] Если правка закрывает пункт из [MISMATCH-LOG.md](MISMATCH-LOG.md) — пункт удалён или переведён в `—` Severity (правило 7).
