...
const HomePromo = (): JSX.Element => {
  return (
    <>
      <section
        className="promotion hidden md:bg-center md:bg-cover md:bg-no-repeat md:h-48 md:max-w-175 lg:max-w-250 xl:max-w-323 md:mx-auto md:flex md:items-center w-full"
