    ...
    <div id="header">
      ...
      <header className="hidden md:block md:pt-[62px] md:pr-4 md:pb-4 md:pl-4 xl:pr-0 xl:pb-0 xl:pl-0">
        <div className="container md:max-w-[700px] lg:max-w-[1000px] xl:max-w-[1292px] mx-auto flex flex-col">
          <div className="flex w-[209px] justify-between relative right-0 self-end cursor-pointer">
            <div className="group">
              <a href="#">
            ...
            <div className="relative group">
              <a href="#"><svg className="fill-[#DFE9F9] hover-target" width="26" height="23" viewBox="0 0 26 23" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path
                  d="M25.433 2.99639C25.3109 2.85815 25.1601 2.74727 24.9907 2.67122C24.8214 2.59518 24.6374 2.55574 24.4512 2.55556H6.50453L6.25128 1.06822C6.20087 0.76986 6.04452 0.498766 5.81004 0.303165C5.57557 0.107564 5.27818 0.000139238 4.97077 0H2.0487C1.70426 0 1.37393 0.134623 1.13038 0.374252C0.886827 0.613882 0.75 0.93889 0.75 1.27778C0.75 1.61667 0.886827 1.94167 1.13038 2.1813C1.37393 2.42093 1.70426 2.55556 2.0487 2.55556H3.87077L6.28635 16.8207L6.34479 16.9791L6.41492 17.1721L6.57076 17.4008L6.69414 17.5439L6.94479 17.71L7.09024 17.7931C7.24128 17.8552 7.40317 17.8877 7.56686 17.8889H21.8538C22.1983 17.8889 22.5286 17.7543 22.7722 17.5146C23.0157 17.275 23.1525 16.95 23.1525 16.6111C23.1525 16.2722 23.0157 15.9472 22.7722 15.7076C22.5286 15.468 22.1983 15.3333 21.8538 15.3333H8.66816L8.45258 14.0556H23.1525C23.465 14.0556 23.7671 13.9448 24.0033 13.7434C24.2394 13.542 24.3939 13.2636 24.4382 12.9592L25.7369 4.01478C25.7632 3.83352 25.7497 3.64882 25.6973 3.47314C25.6449 3.29746 25.5548 3.13489 25.433 2.99639ZM22.9538 5.11111L22.5837 7.66667H17.9577V5.11111H22.9538ZM16.659 5.11111V7.66667H12.763V5.11111H16.659ZM16.659 8.94444V11.5H12.763V8.94444H16.659ZM11.4643 5.11111V7.66667H7.56816L7.37595 7.705L6.93699 5.11111H11.4643ZM7.58634 8.94444H11.4643V11.5H8.01881L7.58634 8.94444ZM17.9577 11.5V8.94444H22.3967L22.0266 11.5H17.9577Z"
                  fill="white" />
                <path
                  d="M9.51621 23C10.5921 23 11.4643 22.1419 11.4643 21.0833C11.4643 20.0248 10.5921 19.1667 9.51621 19.1667C8.44033 19.1667 7.56816 20.0248 7.56816 21.0833C7.56816 22.1419 8.44033 23 9.51621 23Z"
                  fill="white" />
                <path
                  d="M21.2045 23C22.2804 23 23.1525 22.1419 23.1525 21.0833C23.1525 20.0248 22.2804 19.1667 21.2045 19.1667C20.1286 19.1667 19.2564 20.0248 19.2564 21.0833C19.2564 22.1419 20.1286 23 21.2045 23Z"
                  fill="white" />
              </svg></a>
            ...
            <div className="group_stroke">
              <a href="#">
                <svg id="head-heart" className="fill-[#DFE9F9] hover-target w-[29px] h-[25px]" version="1.1"
                  xmlns="http://www.w3.org/2000/svg" x="0px" y="0px"
                  viewBox="0 0 25.8 23.2">
                  <g>
                    <g>
                      <path className="st0"
                        d="M13.1,21.9h-0.4l-0.2-0.1c-1.9-1.2-3.7-2.5-5.4-4c-3.7-3.1-5.7-6.4-5.7-9.6c0-1.7,0.7-3.4,1.8-4.6
                                c1.2-1.2,2.7-1.8,4.4-1.8c2.2,0,4.1,0.9,5.3,2.6l0,0c1.1-1.6,3.1-2.6,5.2-2.6c1.7,0,3.3,0.7,4.5,1.8c1.2,1.2,1.8,2.8,1.8,4.6
                                c0,3.1-1.9,6.3-5.7,9.6c-1.8,1.6-3.6,2.9-5.6,4L13.1,21.9z M7.7,2.9c-1.4,0-2.6,0.5-3.6,1.6c-1,1-1.6,2.4-1.6,3.8
                                c0,2.8,1.8,5.9,5.3,8.8c1.6,1.4,3.3,2.6,5.1,3.8c1.8-1,3.6-2.3,5.3-3.8c3.5-3.1,5.3-6,5.3-8.8c0-1.5-0.6-2.8-1.6-3.8
                                c-1-1-2.4-1.6-3.7-1.6c-1.8,0-3.4,0.9-4.4,2.3L13,6.5l-0.8-1.4C11.1,3.7,9.6,2.9,7.7,2.9z"></path>
                    </g>
                  </g>
                </svg>
              </a>
            ...
            <div className="group">
              <a href="#"><svg className="fill-[#DFE9F9] hover-target" height="25" viewBox="0 0 30 25" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M21.2955 9.09091C21.2955 10.2964 20.8166 11.4526 19.9641 12.305C19.1117 13.1575 17.9555 13.6364 16.75 13.6364C15.5445 13.6364 14.3883 13.1575 13.5359 12.305C12.6834 11.4526 12.2045 10.2964 12.2045 9.09091C12.2045 7.88538 12.6834 6.72923 13.5359 5.87679C14.3883 5.02435 15.5445 4.54545 16.75 4.54545C17.9555 4.54545 19.1117 5.02435 19.9641 5.87679C20.8166 6.72923 21.2955 7.88538 21.2955 9.09091ZM19.0227 9.09091C19.0227 9.69367 18.7833 10.2718 18.3571 10.698C17.9308 11.1242 17.3528 11.3636 16.75 11.3636C16.1472 11.3636 15.5692 11.1242 15.1429 10.698C14.7167 10.2718 14.4773 9.69367 14.4773 9.09091C14.4773 8.48814 14.7167 7.91007 15.1429 7.48385C15.5692 7.05763 16.1472 6.81818 16.75 6.81818C17.3528 6.81818 17.9308 7.05763 18.3571 7.48385C18.7833 7.91007 19.0227 8.48814 19.0227 9.09091Z"
                  fill="#DFE9F9" />
                <path fill-rule="evenodd" clip-rule="evenodd"
                  d="M16.75 0C9.84659 -2.33515e-10 4.25 5.59659 4.25 12.5C4.25 19.4034 9.84659 25 16.75 25C23.6534 25 29.25 19.4034 29.25 12.5C29.25 5.59659 23.6534 2.33515e-10 16.75 0ZM6.52273 12.5C6.52273 14.875 7.33295 17.0614 8.69091 18.7977C9.64458 17.5453 10.8749 16.5304 12.2857 15.8322C13.6966 15.134 15.2497 14.7714 16.8239 14.7727C18.3776 14.7713 19.9113 15.1245 21.3079 15.8054C22.7045 16.4864 23.9272 17.4772 24.883 18.7023C25.8676 17.4109 26.5305 15.9037 26.8169 14.3052C27.1034 12.7068 27.005 11.0631 26.5301 9.51021C26.0552 7.95731 25.2173 6.53983 24.0858 5.37504C22.9543 4.21026 21.5617 3.33166 20.0232 2.81194C18.4847 2.29222 16.8445 2.14633 15.2385 2.38633C13.6324 2.62633 12.1066 3.24533 10.7872 4.19211C9.46789 5.13888 8.39297 6.38622 7.6514 7.8309C6.90983 9.27559 6.52293 10.8761 6.52273 12.5ZM16.75 22.7273C14.4022 22.7308 12.1253 21.9231 10.3045 20.4409C11.0374 19.3917 12.0129 18.5351 13.1479 17.944C14.283 17.3528 15.5441 17.0445 16.8239 17.0455C18.0877 17.0444 19.3335 17.345 20.4579 17.9221C21.5822 18.4992 22.5527 19.3362 23.2886 20.3636C21.4537 21.894 19.1393 22.7306 16.75 22.7273Z"
                  fill="#DFE9F9" />
              </svg></a>
            </div>
          </div>
          <div className="flex justify-between items-center  md:gap-[60px] lg:gap-0">
            <div className="flex items-center justify-start md:gap-[30px] gap-[60px]">
              <Logo />
              <h1
                className="font-lato italic font-bold md:text-[30px] lg:text-[48px] xl:text-[62px] leading-[97%] tracking-[0.02em] text-white md:max-w-[400px] lg:max-w-[440px]">
