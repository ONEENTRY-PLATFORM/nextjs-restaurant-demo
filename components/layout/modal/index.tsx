...
const Modal = ({
  ...
  return (
    <ModalAnimations component={component}>
      <div
        id="modalBody"
        className="z-500 fixed left-1/2 top-1/2 flex size-full max-w-full -translate-x-1/2 -translate-y-1/2 flex-col overflow-auto bg-[rgba(76,77,86,0.8)] backdrop-blur-[10px] p-6 px-16 pt-32 shadow-xl max-sm:px-8 sm:px-16 md:overflow-hidden md:rounded-[20px] lg:h-auto lg:w-137.5 lg:p-10 lg:px-24 lg:pt-32 xl:px-24"
      >
