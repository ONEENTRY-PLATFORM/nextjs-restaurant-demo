          ...
          <div className="w-50%-gap min-w-[370px] p-[10px] flex justify-between items-center border border-gray-300 rounded-[5px]">
            ...
            <div className="flex flex-col justify-between h-[122px]">
              <div className="group_white">
                ...
                >
                  <path
                    d="M21.1047 2.60556C21.0021 2.48534 20.8754 2.38893 20.7332 2.3228C20.5909 2.25668 20.4364 2.22238 20.28 2.22222H5.20478L4.99205 0.928889C4.9497 0.669443 4.81837 0.43371 4.62141 0.263622C4.42445 0.0935341 4.17464 0.000121077 3.91642 0H1.46188C1.17255 0 0.895075 0.117063 0.690491 0.325437C0.485906 0.533811 0.370972 0.816426 0.370972 1.11111C0.370972 1.4058 0.485906 1.68841 0.690491 1.89679C0.895075 2.10516 1.17255 2.22222 1.46188 2.22222H2.99242L5.0215 14.6267L5.07059 14.7644L5.1295 14.9322L5.26041 15.1311L5.36405 15.2556L5.57459 15.4L5.69677 15.4722C5.82364 15.5262 5.95963 15.5545 6.09714 15.5556H18.0982C18.3875 15.5556 18.665 15.4385 18.8696 15.2301C19.0742 15.0217 19.1891 14.7391 19.1891 14.4444C19.1891 14.1498 19.0742 13.8671 18.8696 13.6588C18.665 13.4504 18.3875 13.3333 18.0982 13.3333H7.02222L6.84113 12.2222H19.1891C19.4516 12.2223 19.7053 12.1259 19.9037 11.9508C20.1021 11.7757 20.2318 11.5336 20.2691 11.2689L21.36 3.49111C21.3821 3.3335 21.3707 3.17289 21.3267 3.02012C21.2827 2.86736 21.207 2.72599 21.1047 2.60556ZM19.0222 4.44444L18.7113 6.66667H14.8255V4.44444H19.0222ZM13.7346 4.44444V6.66667H10.4619V4.44444H13.7346ZM13.7346 7.77778V10H10.4619V7.77778H13.7346ZM9.37094 4.44444V6.66667H6.09823L5.93677 6.7L5.56805 4.44444H9.37094ZM6.1135 7.77778H9.37094V10H6.47677L6.1135 7.77778ZM14.8255 10V7.77778H18.5542L18.2433 10H14.8255Z"
                    fill="#EC722B"
                  ></path>
                  <path
