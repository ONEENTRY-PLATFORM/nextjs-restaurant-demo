    ...
    <div className="w-[730px] bg-[rgba(76,77,86,0.8)] p-[20px] rounded-[20px] mt-[200px] mb-auto transform scale-100 opacity-100 transition-all duration-1000">
      ...
      <div className="max-w-[460px] mx-auto px-[30px] pt-[25px]">
        ...
        <form className="flex flex-col gap-[20px] mt-[20px]">
          <div>
            <label className="cart_label" htmlFor="">First name</label>
            <div className="flex items-center border-b border-b-[#b0bcce]">
              <input className="cart_input" type="text" placeholder="One"/>
            </div>
          </div>
          <div>
            <label className="cart_label" htmlFor="">Surname</label>
            <div className="flex items-center border-b border-b-[#b0bcce]">
              <input className="cart_input" type="text" placeholder="Entry"/>
            </div>
          </div>
          <div>
            <label className="cart_label" htmlFor="">Create password</label>
            <div className="flex items-center border-b border-b-[#b0bcce]">
              <input className="cart_input" type="text" placeholder="******"/>
              <svg className="ml-[-25px]" width="24" height="21" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1 1L20.5556 20M10.9587 5.89606C11.5939 5.7131 12.2683 5.70079 12.9101 5.86043C13.552 6.02007 14.1373 6.3457 14.6039 6.80271C15.0705 7.25971 15.401 7.83102 15.5601 8.45589C15.7193 9.08077 15.7012 9.73587 15.5078 10.3516M7.61222 3.23012C12.8238 0.717375 18.4374 2.74562 23 9.3125C21.7448 11.1187 20.4101 12.5817 19.0266 13.7015M15.96 15.5896C10.8707 17.7936 5.43789 15.7013 1 9.3125C2.23444 7.536 3.54589 6.09081 4.90622 4.97813" stroke="white" stroke-opacity="0.9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
              </svg>
            </div>
          </div>
          <div>
            <label className="cart_label" htmlFor="">Confirm password</label>
            <div className="flex items-center border-b border-b-[#b0bcce]">
              <input className="cart_input" type="text" placeholder="******"/>
              <svg className="ml-[-25px]" width="24" height="21" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1 1L20.5556 20M10.9587 5.89606C11.5939 5.7131 12.2683 5.70079 12.9101 5.86043C13.552 6.02007 14.1373 6.3457 14.6039 6.80271C15.0705 7.25971 15.401 7.83102 15.5601 8.45589C15.7193 9.08077 15.7012 9.73587 15.5078 10.3516M7.61222 3.23012C12.8238 0.717375 18.4374 2.74562 23 9.3125C21.7448 11.1187 20.4101 12.5817 19.0266 13.7015M15.96 15.5896C10.8707 17.7936 5.43789 15.7013 1 9.3125C2.23444 7.536 3.54589 6.09081 4.90622 4.97813" stroke="white" stroke-opacity="0.9" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"></path>
          ...
          <div>
            <label className="cart_label" htmlFor="">Your e-mail</label>
            <div className="flex items-center border-b border-b-[#b0bcce]">
              <input className="cart_input" type="text" placeholder="questions@oneentry.cloud"/>
            </div>
          </div>
          <div>
            <label className="cart_label" htmlFor="">Phone number </label>
            <div className="border-b border-b-[#b0bcce]">
              <input className="cart_input" type="text" placeholder="+7 (999) 000 00 00"/>
            </div>
          </div>
