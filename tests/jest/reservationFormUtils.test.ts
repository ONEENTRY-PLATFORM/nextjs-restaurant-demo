...
import {
  ...
  TIME_SLOT_MARKER,
  validateField,
} from '@/components/reservation/reservationFormUtils';
import type { Translate } from '@/components/reservation/reservationTypes';
import type {
  RestaurantOption,
  ScheduleSlotEntry,
} from '@/components/reservation/RestaurantSelect';
